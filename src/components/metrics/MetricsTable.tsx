...
export function MetricsTable({
  ...
  const { data, isFetching, refreshError } = useWebsiteMetricsQuery(websiteId, {
    type,
    limit,
    ...params,
  });
  ...
  return (
    <LoadingPanel data={data} isFetching={isFetching} refreshError={refreshError} minHeight="400px">
      <Grid padding="2">
